...
var _default =
{
  ...
  methods: {
    ...
    handleStart: function handleStart() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var gameId, server, result;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                gameId = _this.$data.gameId;
                server = _this.$data.server + 1;if (!(
                gameId && server)) {_context.next = 10;break;}_context.next = 5;return (
                  _this.$myRequest({
                ...
                console.log(result, '<<<<<<<<<<<==============(result)');_context.next = 11;break;case 10:
